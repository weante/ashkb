...
> 记录截至 **v1.0.30**（versionCode 35，2026-09-20）的全部工程知识。
...
- **最新版**：v1.0.30（versionCode 35）：v1.0.21 知识库检索优化（Room v8→v9）+ v1.0.22 清除 `as MutableStateFlow` 强转 + v1.0.23 化验 Tab 分组折叠 + v1.0.24 通知/VM/PDF 文案资源化 + v1.0.25 Compose 性能审查第一批 + v1.0.26 紧急卡「当前用药」（A1）+ v1.0.27 备份恢复码（A2，v2 信封格式）+ v1.0.28 Compose 性能审查第二批 + v1.0.29 热修 v1.0.28 启动闪退（`SymptomViewModel` 构造期 NPE）+ v1.0.30 趋势图页签切换动画重播修复
